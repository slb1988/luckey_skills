...
description: 生成 Ian 风格的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“怪诞”“小Key”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；默认使用小Key IP、纯白手绘、少量红橙蓝批注、简洁清爽但天马行空的视觉风格。
---
...
默认视觉 IP 是“小Key”：黑色实心、白点眼、细腿、空表情，认真做一件荒诞但成立的事。小Key必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/xiaokey-ip.md`：小Key IP 的形象、性格、动作库和禁忌。
